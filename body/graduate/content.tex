...
与上小节研究的那台单级推进泵相比，在相同的直径空间下，双级推进泵的推力和转矩基本上相当于两台普通单级推进器。
...
\begin{figure}[htbp]
    \centering
    \includegraphics[scale=1.0]{3单级水听器布置.png}
    \caption{\label{fig:sjstq}单级推进泵噪声试验中水听器布置}
\end{figure}
\subsection{推进泵噪声特性分析}
...
说明水速的增大不仅会提升低中高三个频段的噪声能量，还对全频段的声压级有增强作用。
\begin{figure}[htbp]
    \centering
...
\begin{figure}[htbp]
    \centering
    \includegraphics[scale=1.0]{4单级推进泵计算域网格.png}
    \caption{\label{fig:djjisuanyuwangge}计算域网格}
\end{figure}
