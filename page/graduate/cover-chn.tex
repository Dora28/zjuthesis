...
\begin{center}
    \bfseries \zihao{4}
    \begin{tabularx}{.85\textwidth}{>{\fangsong}l X<{\centering}}
        ...
        中文论文题目：      &  \uline{\hfill \fangsong \Title{} \hfill} \\
                          %&  \uline{\hfill} \\ 
        英文论文题目：     & \uline{\hfill Research on acoustic characteristics analysis and characteristic \hfill} \\
