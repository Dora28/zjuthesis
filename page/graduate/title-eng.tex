...
\begin{center}
    ...
    \bfseries \zihao{3}
    \begin{tabularx}{.65\textwidth}{X<{\centering}}
        \uline{\hfill Research on acoustic characteristics analysis and feature line \hfill} \\
        \uline{\hfill  spectrum extraction method of propulsion pump noise           \hfill}
    \end{tabularx}
\end{center}
